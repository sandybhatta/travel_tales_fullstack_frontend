    ...
    <div className='w-full min-h-screen bg-gray-900 text-white font-sans'>
        <div className='sticky top-0 z-10 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800'>
            <div className='flex justify-center items-center max-w-4xl mx-auto'>
                <div className='flex w-full md:w-auto p-1 md:p-2 gap-1 md:gap-4 overflow-x-auto no-scrollbar justify-between md:justify-center'>
                    <button
                        onClick={() => setActivePage("suggestions")}
                        className={`flex-1 md:flex-none px-3 py-2 md:px-6 md:py-3 rounded-full text-xs md:text-base font-medium transition-all duration-300 whitespace-nowrap ${
        ...
        <div className="max-w-4xl mx-auto p-2 md:p-4 min-h-[calc(100vh-80px)]">
