...
const OngoingTrips = ({ongoingTrips,sortBy}) => {
  ...
  if (!Array.isArray(ongoingTrips) || ongoingTrips.length === 0) {
    return (
        ...
        return (
          ...
          >
            ...
            <div className="w-full h-1/2 relative">
              ...
              <span
                className='bg-red-500 text-sm font-semibold px-3 py-1 rounded-lg absolute top-2 left-2 text-white'
              >
                OnGoing
              </span>
