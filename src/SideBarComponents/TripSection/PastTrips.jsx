...
const PastTrips = ({completedTrips,sortBy}) => {
  ...
  if (!Array.isArray(completedTrips) || completedTrips.length === 0) {
    return (
  ...
  if (sortBy === "Start Date") {
    sortedTrips = [...completedTrips].sort(
        ...
        return (
          ...
          >
            ...
            <div className="w-full h-1/2 relative">
              ...
              <span
                className='bg-green-500 text-sm font-semibold px-3 py-1 rounded-lg absolute top-2 left-2 text-white'
              >
                Completed
              </span>
